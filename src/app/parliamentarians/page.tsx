...
const ParliamentariansPage = () => {
  console.log("Parliamentarians page loaded");
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4">Parliamentarians</h1>
      <p className="text-lg">This is a placeholder page for Parliamentarians. Content will be added soon.</p>
    </div>
  );
};

export default ParliamentariansPage;
